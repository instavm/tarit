//! Clone-N-from-1: suspend/resume + CoW disk overlays.
//!
//! Clone = restore the same snapshot N times. Boot+init once,
...
//!
//! Suspend = pause vCPUs + take a snapshot; Resume = restore
//! (ideally UFFD-lazy).
//!
...
pub struct CloneNetSpec {
    pub index: u32,
    /// Unique tap name for this clone (avoids IP collisions).
    pub tap_name: String,
