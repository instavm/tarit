//! vmm-migration: cross-host live migration (PRD §9d).
//!
//! PRD §9d: "Cross-host live migration is the same pre-copy / post-copy loop
//! as the live snapshot (§9c), but the destination is a peer host instead of
