...
//!
//! PRD §8: "Default-deny egress; allow only an explicit per-VM/per-session
//! allowlist of CIDRs/ports." This module supports updating that allowlist
//! on a running VM without restarting it.
//!
