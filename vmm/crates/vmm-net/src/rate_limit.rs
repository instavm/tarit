...
//!
//! PRD §7 / §8: "token-bucket rate limiter on IOPS/bandwidth per device"
//! (Firecracker ships this per microVM).
//!
//! Unit-testable without KVM (PRD §12.1: "Rate-limiter token-bucket math
//! (burst, refill, starvation)").
