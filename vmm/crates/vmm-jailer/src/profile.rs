//! seccomp-BPF profile compilation.
//!
...
//!
//! Tested by attempting disallowed syscalls from vCPU/device threads and
//! asserting the process is killed/denied.
//!
...
impl VmmSeccompProfiles {
    ...
    /// profiles are tighter and kernel-version-dependent; this is the
    /// scaffold shape.
    pub fn minimal() -> Self {
        Self {
...
///
/// The denylist encodes the "tight syscall filter" intent: the jailed
