...
//!
//! PRD §12.1: "virtio-queue descriptor parsing: malformed/looping/overlapping
//! descriptor chains must be rejected (fuzz-seeded)." We delegate to
...
/// Max descriptors in a chain we'll follow (matches Firecracker's limit).
...
/// does; extracted here so the malformed-chain rejection tests (PRD §12.1)
