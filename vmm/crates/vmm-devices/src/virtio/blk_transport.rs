...
/// virtio-blk feature bits we advertise (matching Firecracker's minimal set).
        ...
        match off {
            reg::STATUS => {
                ...
                if val == 0 {
                    ...
                    // all negotiated state so a re-probe starts clean (mirrors
                    // Firecracker's MmioTransport::reset).
