//! x86_64 CPU templates — precomputed CPUID + MSR masks (PRD §5, §9d).
//!
//! PRD §5: "CPU templates — precomputed CPUID/MSR templates to avoid
//! per-boot feature negotiation." PRD §9d: "enforce via CPU templates masked
//! to a common fleet baseline, and reject incompatible targets at
//! negotiation."
//!
...
/// A named CPU template (Firecracker-style: "T2", "T2S", "T2CL", ...).
...
impl CpuTemplate {
    ...
    /// (the real Firecracker T2 masks dozens; this is the scaffold).
...
mod tests {
    ...
    fn template_serializes_round_trip() {
        ...
        // migration negotiation channel (PRD §9d).
