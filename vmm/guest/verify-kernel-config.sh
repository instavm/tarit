...
for option in \
  ...
  VIRTIO_BLK VIRTIO_NET VIRTIO_BALLOON HW_RANDOM HW_RANDOM_VIRTIO \
  VSOCKETS VIRTIO_VSOCKETS SERIAL_8250 \
  SERIAL_8250_CONSOLE EXT4_FS PROC_FS SYSFS TMPFS DEVTMPFS \
  DEVTMPFS_MOUNT BINFMT_ELF UNIX INET TTY UNIX98_PTYS; do
...
for option in \
  ...
  HW_RANDOM_TIMERIOMEM HW_RANDOM_INTEL HW_RANDOM_AMD HW_RANDOM_BA431 \
  HW_RANDOM_VIA HW_RANDOM_XIPHERA \
