...
Tarit (Sanskrit for lightning) is a microVM platform for secure, fast, ephemeral
...
[vmm/membench/LIVESNAP-MEMBENCH.md](vmm/membench/LIVESNAP-MEMBENCH.md), and
...
Numbers from a bare-metal KVM host (cold boot, create-to-exec, warm-pool
time-to-first-exec, live-snapshot memory bandwidth):
[vmm/docs/METAL-BENCHMARKS.md](vmm/docs/METAL-BENCHMARKS.md),
[vmm/docs/cold-boot-bench.md](vmm/docs/cold-boot-bench.md), and
[vmm/membench/LIVESNAP-MEMBENCH.md](vmm/membench/LIVESNAP-MEMBENCH.md).
...
The AGPL network clause means that if you run a modified Tarit as a network
service, you must offer your modified source to its users. For a commercial
license without the AGPL obligations (dual licensing), contact the maintainers.
