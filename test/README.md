...
Results print as a table and are written under `bench-results/`. See
[../vmm/docs/METAL-BENCHMARKS.md](../vmm/docs/METAL-BENCHMARKS.md) for reference
numbers on a bare-metal host.
