...
```python
from tarit_sdk import AuthenticatedClient
...
```python
from tarit_sdk.models import MyDataModel
from tarit_sdk.api.my_tag import get_my_data_model
from tarit_sdk.types import Response
...
1. Any endpoint which did not have a tag will be in `tarit_sdk.api.default`
