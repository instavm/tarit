...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/branches/{id}/fork".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Fork an isolated VM from a branch head
     ...
     Alias of branch restore for clients expressing branch lineage as a fork. The child receives a new VM
    identity and isolated writable state.
