...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ShareRecord.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Update port share
     ...
     Changes one or more share fields. Changing `vm_id`, `guest_port`, or `visibility` invalidates
    previously issued private-share tokens.
